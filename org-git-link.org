...
* Sandbox:
  ...
  [[gitbare:.git:::test/testgitrepos/unicorn.png]]
* Tasks:
...
** DONE check whether viewing images also works
   ...
   :END:
** Implement git link                                          :PROJECT:
*** TODO refactor existing code so that git link can call gitbare link infrastructure
*** DONE write helper function to split dir path into parent dir and rest
    ...
    :END:
*** STARTED write function which finds git-dir
     :LOGBOOK:
     CLOCK: [2009-10-13 Tue 17:22]--[2009-10-13 Tue 18:10] =>  0:48
     :END:
** TODO Find way not not load identical files multiple times
