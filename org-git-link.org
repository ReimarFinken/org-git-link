...
** Testing whether git directory is valid
     Valid git directory can be tested with git-rev-parse --git-dir=...
...
: '
** STARTED Decide whether to write to a buffer or to a temporary file
   :LOGBOOK:
   ...
   treated according to auto-mode-alist. Maybe I should decide
